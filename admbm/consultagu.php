...
$filtro = isset($_GET['filtro'])?$_GET['filtro']:"";
    ...
    $sql = "SELECT * FROM `usuarios_bm` WHERE gu = 'a'";
    $consulta = mysqli_query($conexao,$sql);
    $registros = mysqli_num_rows($consulta);

    $sqlb = "SELECT * FROM `usuarios_bm` WHERE gu = 'b'";
    $consultab = mysqli_query($conexao,$sqlb);
    $registrosb = mysqli_num_rows($consultab);
?>
        ...
        <div id="content">
            ...
            <div class="card text-center">
                <div class="card-header">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="consultabombeiros.php">Bombeiros Militares</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="consultagu.php">Consulta a GU</a>
                    </li>
                    <li class="nav-item">
            ...
            echo "<table id='consulta'>";
                ...
                while ($exibirRegistrosb = mysqli_fetch_array($consultab)){
                    $id = $exibirRegistrosb[0];
                    $matricula = $exibirRegistrosb[1];
                    $nomedeguerra = $exibirRegistrosb[2];
					$nome = $exibirRegistrosb[3];
					$graduacao = $exibirRegistrosb[4];
					$antiguidade= $exibirRegistrosb[5];
					$gu= $exibirRegistrosb[6];
                    $status= $exibirRegistrosb[7];
                //}
                echo "<tr>";
